...
# Load the data
latent_scores = pd.read_csv('data/latent_variable_scores_post_30.csv')  # Latent variable scores
data_test_model = pd.read_csv('post_30_data.csv')  # Original dataset
...
# Prepare the data
X_indicators = data_scaled_df[['CSSD', 'BWBp', 'Price', 'Sentiment', 'InvestorAttention', 'LaggedTradingVolume', 'LaggedTurnoverRatio']]
...
path_coefficients = {
    'Herding': {'CSSD': 0.100},
    'Overconfidence': {'BWBp': -0.346, 'Price': -0.346},
    'FoMO': {'Sentiment': 0.511, 'InvestorAttention': 0.511},
    'LaggedTradingVolume': {'LaggedTradingVolume': 0.088},
    'LaggedTurnoverRatio': {'LaggedTurnoverRatio': 0.329}
...
loadings = {'TradingVolume': 0.770, 'TurnoverRatio': 0.830} #Replace with your actual loadings.
